...
function onSuccess() {
  ...
  mqtt.subscribe('DZ/rasp/led', {qos: 1}); // Assina o Tópico led/1
...
function led(value){ // Evento do Botão Desligar
    ...
    message.destinationName = "DZ/rasp/led"; // Define o tópico a ser enviado, neste caso: led/1
    mqtt.send(message); // Envia a mensagem
};

$(document).ready(function(){

  $('#btn-on').click(function(){ led("1"); });
  $('#btn-off').click(function(){ led("0"); });
